...
<div class="hero-unit-table">   
    ...
    $query = mysqli_query($aVar,"select * from tb_products");
    while ($row = mysqli_fetch_array($query)) {
    $id = $row['productID'];
	
							
	$query1 = mysqli_query($aVar,"SELECT *,SUM(qty) as qty FROM order_details WHERE productID = '$id' AND status = 'Delivered'");
   ...
   <!--  <td style="text-align:center;"><?php echo $total; ?></td>  -->
    ...
    <img src="<?php echo $row['location']; ?>" class="img-rounded" width="50" height="40"></td> 
    <td width="160">
    <a href="#delete_product<?php echo $id; ?>" role="button"  data-target = "#delete_product<?php echo $id;?>"data-toggle="modal" class="btn btn-danger">Delete</a>
